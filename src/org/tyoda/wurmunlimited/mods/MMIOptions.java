...
public class MMIOptions {
    ...
    private RemodelAction remodelAction;
    private ResetModelAction resetModelAction;
    private RandomModelAction randomModelAction;
    private MMIBehaviour mmiBehaviour;
